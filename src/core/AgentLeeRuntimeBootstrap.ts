// Ensure CollectiveRuntime is attached to globalThis before any runtime checks
import '../core/AgentLeeCollectiveRuntime';
/*
...
export class AgentLeeRuntimeBootstrap {
  ...
  async initialize(): Promise<void> {
    ...
    try {
      ...
      // Initialize SovereignExecutionEngine (Phase 2 runtime foundation)
      const sovereignEngine = new SovereignExecutionEngine({
